...
public class Activity1 extends AppCompatActivity {
    ...
    public void openChoiceLogger() {
        Button button2_1 = (Button) findViewById(R.id.button1_1);
        Button button2_2 = (Button) findViewById(R.id.button1_2);
        Button button2_3 = (Button) findViewById(R.id.button1_3);

        button2_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Activity1.this, ChoiceLogger.class));
            }
        });
